...
export const githubPushToBranchTrigger: TriggerConfig = {
  id: 'github_push_to_branch',
  name: 'GitHub Push to Branch',
  provider: 'github',
  description: 'Trigger workflow when code is pushed to a specific branch',
  version: '1.0.0',
  icon: GithubIcon,
  ...
  subBlocks: [
    ...
    },
    {
      ...
      type: 'short-input',
      placeholder: 'main, develop, feature/*, release-*',
      description:
        'Branch name or pattern to match. Supports wildcards (*). Comma-separated for multiple patterns.',
      required: true,
      mode: 'trigger',
      condition: {
        field: 'selectedTriggerId',
    ...
    },
    {
      ...
      defaultValue: [
        ...
        '<em>Note: Branch filtering happens on this end based on the pattern you configure above.</em>',
      ]
        .map(
          (instruction, index) =>
    ...
    },
    {
      ...
      hideFromPreview: true,
      mode: 'trigger',
      triggerId: 'github_push_to_branch',
      condition: {
        field: 'selectedTriggerId',
        value: 'github_push_to_branch',
      },
  ...
  outputs: {
    ...
    branch: {
      type: 'string',
      description: 'Branch name extracted from ref (e.g., main)',
    },
    before: {
      type: 'string',
    ...
    created: {
      type: 'boolean',
      description: 'Whether this push created a new branch',
    },
    deleted: {
      type: 'boolean',
      description: 'Whether this push deleted a branch',
    },
    forced: {
      type: 'boolean',
    ...
    commits: {
      ...
      items: {
        ...
        added: { type: 'array', description: 'Array of file paths added in this commit' },
        removed: { type: 'array', description: 'Array of file paths removed in this commit' },
        modified: { type: 'array', description: 'Array of file paths modified in this commit' },
      },
    },
    head_commit: {
      ...
      added: { type: 'array', description: 'Array of file paths added' },
      removed: { type: 'array', description: 'Array of file paths removed' },
      modified: { type: 'array', description: 'Array of file paths modified' },
    },
    pusher: {
